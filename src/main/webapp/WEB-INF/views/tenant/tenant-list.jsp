...
<head>
    ...
    <title>Quản Lý Khách Thuê - BOA</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="${pageContext.request.contextPath}/quan-ly-khach-thue">Khách Thuê</a>
                </li>
                <li class="nav-item">
...
<div class="main-container">
    ...
    <div class="content-section">
        ...
        <div class="action-bar">
            <a href="${pageContext.request.contextPath}/quan-ly-khach-thue?action=showAddForm" class="btn-add">
                <i class="fas fa-user-plus"></i> Thêm Khách Thuê Mới
            </a>
            <div class="search-box">
                <i class="fas fa-search"></i>
                <input type="text" id="searchInput" placeholder="Tìm kiếm khách thuê..." class="form-control">
            </div>
        </div>
            ...
            <c:choose>
                <c:when test="${empty tenants}">
                    <div class="empty-state">
                        ...
                        <h4>Chưa có khách thuê nào</h4>
                        <p>Bắt đầu bằng cách thêm khách thuê đầu tiên của bạn.</p>
                    </div>
                </c:when>
                <c:otherwise>
                        ...
                        <tbody>
                            <c:forEach var="tenant" items="${tenants}" varStatus="status">
                                <tr>
                                    ...
                                    <td>
                                        <a href="${pageContext.request.contextPath}/quan-ly-khach-thue?action=showEditForm&id=${tenant.tenantId}"
                                           class="btn-action btn-edit">
                                            <i class="fas fa-edit"></i> Sửa
                                        </a>
                                        <a href="#"
                                           onclick="confirmDelete(${tenant.tenantId}, '${tenant.name}')"
...
<script>
    ...
    function confirmDelete(tenantId, tenantName) {
        if (confirm('Bạn có chắc chắn muốn xóa khách thuê "' + tenantName + '"?\n\nLưu ý: Không thể xóa khách thuê đang có hợp đồng hoạt động.')) {
            window.location.href = '${pageContext.request.contextPath}/quan-ly-khach-thue?action=delete&id=' + tenantId;
        }
    }
</script>
